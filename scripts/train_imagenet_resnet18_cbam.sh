...
CUDA_VISIBLE_DEVICES=0,1 python train_imagenet.py --ngpu 4 --workers 8 --arch resnet_cascade --depth 18 --epochs 100 --batch-size 256 --lr 0.1 --att-type CBAM --prefix ../../chekpoint/RESNET18_IMAGENET_CAS_SE /Datasets/imagenet/
